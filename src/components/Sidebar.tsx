...
export default function Sidebar({ activeSection }: SidebarProps) {
  ...
  return (
    <div className="bg-auto w-64 absolute top-20 left-12 flex flex-col items-center min-h-screen">
      <h1 className="text-white font-extrabold text-3xl mb-8" style={{opacity: 1}}>Sidebar</h1>
      ...
      <ul className="flex flex-col space-y-4 w-full text-white text-xl">
        {navigationItems.map((item, index) => (
          <li
            ...
            } p-8 rounded-lg hover:bg-opacity-50 transition-all hover-lift cursor-pointer`}
